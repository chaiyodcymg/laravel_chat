<div>
    ...
    <div class="card mt-3 shadow-custom">
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between  border-bottom  border-top">
                ...
                <label for="text-comment{{$i}}"class="btn btn-comment d-flex  justify-content-center commentpop">
            ...
            <div class="pop">
                <div class="popup popup-comment" wire:ignore.self>
                    ...
                    <div class="comment-textarea">
                        ...
                        <textarea wire:keydown.enter="comment({{$post->id}})" wire:model="text_comment.{{$post->id}}" class="card text-comment" id="text-comment{{$i}}" rows="1" name="write_comment" placeholder="Write comment..."></textarea>
  ...
  <div class="modal-delete-post w-100">
    <div class="modal" tabindex="-1" role="dialog" id="editModal1" wire:ignore>
        <div class="modal-dialog" role="document">
            <div class="modal-content" wire:ignore.self>
                <div class="modal-header p-2 d-flex justify-content-center">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{route('edit',$postshow->id)}}" method="post">
                        @csrf
                        <textarea name="whitten_post" id="textarea_post" rows="3" placeholder="What's on your mind ?" value="{{$postshow->whitten_post}}" class="pt-3 pl-0 w-100" onfocus="delete_post(this,'1');" onblur="delete_post(this,'1')" onkeyup="delete_post(this,'1');">{{$postshow->whitten_post}}</textarea>
                        <div class="modal-footer pl-0 pr-0 pb-0">
                            <button type="submit" class="btn btn-secondary w-100 disabled" id="editpost1">Edit</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <div class="modal modal-like-post w-100 " tabindex="-1" role="dialog" id="likedModal1" wire:ignore.self>
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header p-2 d-flex justify-content-center">
                    <h5 class="modal-title">User who liked you</h5>
...
<div class="col-md-7 ">
    <div class="card  shadow-custom showpost">
        <div class="card-body">
            <div class="d-flex align-items-center">
                ...
                <div class="dropleft list-icon" wire:ignore>
                    ...
                    <div class="dropdown-menu ">
                    <a class="dropdown-item" class="btn btn-primary" data-toggle="modal" data-target="#editModal1">Edit post</a>
                        <a class="dropdown-item text-danger" class="btn btn-primary" data-toggle="modal" data-target="#deleteModal1">Delete post</a>
                    </div>

                    <div class="modal-delete-post w-100">
                        <div class="modal" tabindex="-1" role="dialog" id="deleteModal1">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content" wire:ignore.self>
                                    <div class="modal-header p-2 d-flex justify-content-center">
                                        <h5 class="modal-title">Delete Post</h5>
            ...
            <div class="d-flex justify-content-between mt-1 liked-comment">
                ...
                <a class="liked cursor-pointer" data-toggle="modal" data-target="#likedModal1" wire:poll.keep-alive>
            ...
            <div class="pop">
                <div class="popup popup-comment" wire:ignore.self>
                    ...
                    <div class="comment-textarea">
                        ...
                        <textarea wire:keydown.enter="comment({{$postshow->id}})" wire:model="text_comment.{{$postshow->id}}" class="card commententer text-comment" id="text-comment{{$i}}" rows="1" name="write_comment" placeholder="write a comment..."></textarea>
                    ...
                    <div class="all-comment">
                        <div class="d-flex align-items-center comment-box">
                            ...
                            <div class="delete_comment ml-2" wire:ignore.self>
                                ...
                                <div class="dropdown-menu " wire:ignore>
                                    <a class="dropdown-item text-danger" class="btn btn-primary" data-toggle="modal" data-target="#deletecomment1">ลบคอมเมนต์</a>
                                </div>
    
                                <div class="modal-delete-comment w-100">
                                    <div class="modal" tabindex="-1" role="dialog" id="deletecomment1" wire:ignore.self>
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header p-2 d-flex justify-content-center">
                                                    <h5 class="modal-title">ลบคอมเมนต์</h5>
