<div class="modal-delete-post w-100">
    <div class="modal" tabindex="-1" role="dialog" id="editModal{{++$i}}" wire:ignore>
            ...
            <div class="modal-content" wire:ignore.self>
                ...
                <div class="modal-body">
                    ...
                    <form action="{{route('edit',$post->id)}}" method="post">
                        @csrf
                        <textarea name="whitten_post" id="textarea_post" rows="3" placeholder="What's on your mind ?" value="{{$post->whitten_post}}" class="pt-3 pl-0 w-100" onfocus="delete_post(this,'{{$i}}');" onblur="delete_post(this,'{{$i}}')" onkeyup="delete_post(this,'{{$i}}');">{{$post->whitten_post}}</textarea>
                        <div class="modal-footer pl-0 pr-0 pb-0">
                            <button type="submit" class="btn btn-secondary w-100 disabled" id="editpost{{$i}}">Edit</button>
                        </div>
                    </form>
                </div>
            </div>
