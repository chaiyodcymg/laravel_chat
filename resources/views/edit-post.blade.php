            ...
            <div class="modal-content" wire:ignore.self>
                ...
                <div class="modal-body">
                    ...
                    <form action="{{route('edit',$post->id)}}" method="post">
                        @csrf
                        <textarea name="whitten_post" id="textarea_post" rows="3" placeholder="{{$post->whitten_post}}" value="{{$post->whitten_post}}" class="pt-3 pl-0 w-100" onfocus="update_textlen(this);" onblur="update_textlen(this);" onkeyup="update_textlen(this);">{{$post->whitten_post}}</textarea>
