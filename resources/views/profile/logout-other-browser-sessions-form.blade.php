<x-jet-action-section>
    ...
    <x-slot name="content">
    <b style="font-size: 2rem;">Other browser session</b>
        <div class="max-w-xl text-sm text-gray-600" style="width: 50vw; max-width:600px; min-width:400px;">
        ...
        <div class="flex items-center mt-5">
            <button class="btn bg-dark text-white" wire:click="confirmLogout" wire:loading.attr="disabled">
        ...
        <x-jet-dialog-modal wire:model="confirmingLogout">
            ...
            <x-slot name="footer">
                ...
                <button class="ml-3 btn bg-dark text-white" wire:click="logoutOtherBrowserSessions" wire:loading.attr="disabled">
                    {{ __('Log Out Other Browser Sessions') }}
                </button>
            </x-slot>
        </x-jet-dialog-modal>
